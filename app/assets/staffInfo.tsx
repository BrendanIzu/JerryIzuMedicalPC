...
export const staffInfo: Person[] = [
  {
    ...
    about: 'Dr. Izu received his medical degree from The Uniformed Services University \
    ...
    additional: 'Dr. Izu was on faculty for the San Antonio Uniformed Services Health \
