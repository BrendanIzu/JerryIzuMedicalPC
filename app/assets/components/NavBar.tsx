  ...
  return (
    <div className="flex justify-between m-16">
      ...
      <div style={{flex: 2, display: 'flex', gap: '50px', justifyContent: 'flex-end', alignItems: 'center'}}>
        ...
        <Link href='/visit'>
          <h5 className={isActive('/visit') ? "text-pink" : ""}>Your First Visit</h5>
        </Link>
        <Link className="px-8 py-3 rounded-full bg-pink text-white shadow hover:bg-light-pink" href='/contact'>Make an Appointment</Link>
      </div>
